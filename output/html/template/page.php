...
?>
<!doctype html>
<!--[if lt IE 7]><html class="no-js lt-ie9 lt-ie8 lt-ie7" lang="<?=$language->current->code?>"><![endif]-->
<!--[if IE 7]><html class="no-js lt-ie9 lt-ie8" lang="<?=$language->current->code?>"><![endif]-->
<!--[if IE 8]><html class="no-js lt-ie9" lang="<?=$language->current->code?>"><![endif]-->
<!--[if gt IE 8]><!--><html class="no-js" lang="<?=$language->current->code?>"><!--<![endif]-->
<head>
...
<?php } ?>
    <?=$view('monolyth\render\slice/head')?>
    <?=$Css?>
<?php
